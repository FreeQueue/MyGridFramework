...
namespace Framework.Kits.StreamKits
{
	public class MergedStream : Stream
	{
		...
		private long VirtualLength { get; }
		...
		public override long Seek(long offset, SeekOrigin origin)
		{
			...
			if (_position >= Stream1.Length)
				_position = Stream1.Length + Stream2.Seek(offset - Stream1.Length, SeekOrigin.Begin);
			else
				_position = Stream1.Seek(offset, SeekOrigin.Begin);
