...
namespace ES3Internal
{
    public class ES3Prefab : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            ES3ReferenceMgrBase mgr = ES3ReferenceMgrBase.Current;
        ...
        public Dictionary<string, string> GetReferences()
        {
            ...
            ES3ReferenceMgrBase refMgr = ES3ReferenceMgr.Current;
        ...
        public void GeneratePrefabReferences()
        {
            ...
            foreach (Object obj in ES3ReferenceMgr.CollectDependencies(gos))
            {
...
namespace ES3Types
{
    ...
    public class ES3Type_ES3PrefabInternal : ES3Type
    {
        ...
        public override object Read<T>(ES3Reader reader)
        {
            ...
            ES3Prefab es3Prefab = ES3ReferenceMgrBase.Current.GetPrefab(prefabId);
            if (es3Prefab == null)
            ...
            Object instance = Application.isPlaying ? GameObject.Instantiate(es3Prefab.gameObject) : PrefabUtility.InstantiatePrefab(es3Prefab.gameObject);
#else
