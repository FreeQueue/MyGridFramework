...
public abstract class ES3Writer : IDisposable
{
	...
	public virtual void Write(object value, ES3.ReferenceMode memberReferenceMode = ES3.ReferenceMode.ByRef)
	{
        ...
        ES3Type type = ES3TypeMgr.GetOrCreateES3Type(value.GetType());
	...
	{
        ES3ReferenceMgrBase refMgr = ES3ReferenceMgrBase.Current;
        if (refMgr == null)
	...
	{
		ES3Reflection.ES3ReflectedMember property = ES3Reflection.GetES3ReflectedProperty(objectContainingProperty.GetType(), name);
		if(property.IsNull)
	...
	{
		ES3Reflection.ES3ReflectedMember field = ES3Reflection.GetES3ReflectedMember(objectContainingField.GetType(), name);
		if(field.IsNull)
