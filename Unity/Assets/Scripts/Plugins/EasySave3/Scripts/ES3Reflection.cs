...
namespace ES3Internal
{
    public static class ES3Reflection
    {
        ...
        public static bool TypeIsSerializable(Type type)
        {
            ...
            ES3Type es3Type = ES3TypeMgr.GetOrCreateES3Type(type, false);
        ...
        {
            PropertyInfo propertyInfo = ES3Reflection.GetProperty(type, propertyName);
        ...
        {
            FieldInfo fieldInfo = ES3Reflection.GetField(type, fieldName);
