...
namespace ES3Internal
{
    ...
    public abstract class ES3ReferenceMgrBase : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                ES3ReferenceMgrBase existing = _current;
        ...
        internal UnityEngine.Object Get(long id, Type type, bool suppressWarnings=false)
        {
            ...
            {
                Object globalRef = GlobalReferences.Get(id);
                if (globalRef != null)
                    return globalRef;
            }
        ...
        private static void CollectDependenciesFromFields(UnityEngine.Object obj, HashSet<UnityEngine.Object> dependencies, int depth)
        {
            ...
            try
            {
                ...
                if(obj is Texture)
                {
                    ...
                    foreach(Object dependency in UnityEditor.AssetDatabase.LoadAllAssetsAtPath(UnityEditor.AssetDatabase.GetAssetPath(obj)))
                        if (dependency != obj)
        ...
        internal static bool CanBeSaved(UnityEngine.Object obj)
        {
            ...
            foreach (HideFlags flag in invalidHideFlags)
